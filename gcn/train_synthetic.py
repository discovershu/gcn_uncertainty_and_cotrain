...
flags.DEFINE_float('test_ratio', 0.2, 'test ratio.')
flags.DEFINE_integer('nodes', 400, 'network nodes size.')

# Load data
adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask = load_data_syn(FLAGS.test_ratio, 0, seed, FLAGS.nodes)
