...
from voc_data_process_for_multiclass import *
...
image_id = "2009_003991"

# Load data
adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask = load_voc_data_multiclass(seed, test_ratio=0.9, img_name=image_id, scribble = False)
