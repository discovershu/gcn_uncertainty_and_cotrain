...
if __name__ == '__main__':
    ...
    # get_un_all_ood()
    # for dataset in datasets[:]:
    #     Baye_result = np.load("data/ood/result/baye_500_result_{}_ood.npy".format(dataset))
    #     uncertainty2 = get_uncertainty(Baye_result)
    # #     # np.save("data/ood/uncertainty_{}_ood.npy".format(dataset), uncertainty)
    #     uncertainty = np.load("data/ood/all/uncertainty_all_{}_ood.npy".format(dataset))
    #     uncertainty1 = np.load("data/ood/1000/uncertainty_all_{}_ood_1000.npy".format(dataset))
    #     # recall, precision = test_ood_aupr2(dataset, uncertainty)
    #     # np.save("data/ood/all/recall_{}_ood_1000.npy".format(dataset), recall)
    #     # np.save("data/ood/all/precision_{}_ood_1000.npy".format(dataset), precision)
    #     tpr, fpr = test_ood_auroc2(dataset, uncertainty)
    #     np.save("data/ood/all/threshold/fpr_{}_ood0.02_1000.npy".format(dataset), fpr)
    #     np.save("data/ood/all/threshold/tpr_{}_ood0.02_1000.npy".format(dataset), tpr)
    # for dataset in datasets[:]:
    #     x = np.arange(0.0, 1.00001, 0.05)
    #     x = np.around(x, 2)
    #     Baye_result = np.load("data/ood/baye_500_result_{}_ood.npy".format(dataset))
    #     uncertainty = get_uncertainty(Baye_result)
    #     # np.save("data/ood/1000/uncertainty_{}_ood.npy".format(dataset), uncertainty)
    #     # uncertainty = np.load("data/ood/all/uncertainty_all_{}_ood.npy".format(dataset))
    #     tpr, fpr = test_ood_auroc(dataset, uncertainty)
    #     tpr = np.array(tpr)
    #     fpr = np.array(fpr)
    #     tpr = np.around(tpr, 2)
    #     fpr = np.around(fpr, 2)
    # test_ood_aupr3()
        ...
        # np.save("data/ood/all/tpr_{}_ood_1000.npy".format(dataset), tpr)
        # np.save("data/ood/all/fpr_{}_ood_1000.npy".format(dataset), fpr)
    # uncertainty_test_ratio2()
    # get_un_all_ood()
    # e = 'evasion'
    # p = 'poisoning'
    # get_un_adv(e, 50)
    ...
    bayere = np.load("/network/rit/lab/ceashpc/sharedata_shu/vocnew2/voc_baye_predict_outputs_node_label_333_500_0.01_0.2train_1000_3_car4.npy")
    result = get_uncertainty(bayere)
    np.save("/network/rit/lab/ceashpc/sharedata_shu/vocnew2/voc_baye_un_outputs_node_label_333_500_0.01_0.2train_1000_3_car4_new.npy", result)

    # bayere = np.load("/network/rit/lab/ceashpc/sharedata_shu/gcn_un_epstemic/gcn_cora_baye_10000.npy")
    # result = get_uncertainty(bayere)
    # np.save("/network/rit/lab/ceashpc/sharedata_shu/gcn_un_epstemic/gcn_cora_baye_un_10000.npy",result)

    # gcn_pred = np.load("/network/rit/lab/ceashpc/sharedata_shu/voc/voc_predict_outputs_node_label_80_125_200_2.npy")
    # un_gcn, _ = entropy(gcn_pred)
    # np.save("/network/rit/lab/ceashpc/sharedata_shu/voc/voc_gcn_ori_un_outputs_node_label_80_125_200_2.npy", un_gcn)