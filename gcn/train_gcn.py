...
print(result)
print("Random accuracy=", "{:.5f}".format(np.mean(result)), "Random std=", "{:.5f}".format(np.std(result)))
# np.save("/network/rit/lab/ceashpc/sharedata_shu/gcn_citeseer_10.npy", result)
